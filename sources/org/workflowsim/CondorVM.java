...
public class CondorVM extends Vm {
	...
	/*
	 * The state of a vm. It should be either WorkflowSimTags.VM_STATUS_IDLE or
	 * VM_STATUS_READY (not used in workflowsim) or VM_STATUS_BUSY
	 */
	private int state;

	/**
	 * Monetary computation cost per unit time
	 */
	private double price;

	/**
	 * Monetary data transfer out per MB
	 */
	 ...
	 * @post $none
	 */
	public CondorVM(int id, int userId, double mips, int numberOfPes, int ram,
	...
	public void setDataTransferOutPrice(double dataTransferOutPrice) {
